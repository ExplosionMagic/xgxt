<template>
  <div class="register-container">
    <el-card class="box-card">
      <h2>学生账号注册</h2>
      <el-form ref="registerFormRef" :model="form" :rules="rules" label-width="80px" size="default">
...
const handleRegister = () => {
  ...
  // 触发 Element Plus 全局校验
  registerFormRef.value.validate((valid) => {
    if (valid) {
      // 校验通过（手机号符合正则、必填项都填了）才会走到这里！
      ...
      // 校验不通过，Element Plus 会自动在输入框下面飘红字，我们只需弹个提示即可
