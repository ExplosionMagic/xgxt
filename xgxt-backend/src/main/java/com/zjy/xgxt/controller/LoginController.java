...
public class LoginController {
    ...
    public Result<Map<String, Object>> login(@RequestBody Map<String, String> form) {
        ...
        resData.put("auditStatus", user.getAuditStatus());
